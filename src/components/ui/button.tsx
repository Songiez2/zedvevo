...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-electric-blue to-electric text-white hover:shadow-glow',
        destructive:
          'bg-red-500 text-white hover:bg-red-600',
        outline:
          'border border-border bg-transparent hover:bg-accent hover:text-accent-foreground',
        secondary:
          'bg-mid-gray text-white hover:bg-dark-gray',
        ghost:
          'hover:bg-accent hover:text-accent-foreground',
        link:
          'text-electric underline-offset-4 hover:underline',
        glass:
          'bg-glass backdrop-blur-lg border border-white/10 hover:bg-white/20 text-white',
      },
      size: {
